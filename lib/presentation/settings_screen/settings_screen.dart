...
import 'package:start1/widgets/app_bar/appbar_leading_iconbutton.dart';
import 'package:start1/widgets/app_bar/custom_app_bar.dart';
import 'package:start1/widgets/custom_outlined_button.dart';
...
class SettingsScreen extends GetWidget<SettingsController> {
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Column(children: [
                  ...
                  _buildLanguage(languageLabel: "lbl_personality".tr),
                  SizedBox(height: 14.v),
                  _buildLanguage(languageLabel: "lbl_language".tr),
                  SizedBox(height: 14.v),
                  _buildLanguage(languageLabel: "msg_terms_and_conditions".tr),
                  Spacer(),
  ...
  /// Common widget
  Widget _buildLanguage({required String languageLabel}) {
    return Container(
